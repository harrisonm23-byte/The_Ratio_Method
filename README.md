...
The Ratio Method is a systematic way to design regulation for novel risks posed by AI. This framework profiles an activity, product, or industry by a set of variables. Once profiled, the underlying risk is matched to a precedent liability regime with similar / matching variables.
