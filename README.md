...
The Ratio Method is a systematic way to design regulation for novel risks posed by AI. It is a framework that profiles an activity, product, or industry by a set of variables. Once a risk is profiled, the underlying activity is matched to a historical liability regime with similar / matching variables.
