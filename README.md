...
The **Precedents** report applies the method to 8 risks named in the **International AI Safety Report 2026**, and compares each to sixteen existing liability regimes.
